...
const Sidebar: React.FC<SidebarProps> = ({ settings, setSettings, onGenerate, isGenerating }) => {
  ...
  return (
    <div className="w-1/3 h-full bg-[#060b3b] border-r border-gray-800 flex flex-col shadow-xl z-20">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar">
        ...
        <section className="space-y-4">
          ...
          <div>
            <label className="block text-gray-400 text-xs mb-1">Bối cảnh câu chuyện</label>
            <textarea 
          ...
          <div>
            <label className="block text-gray-400 text-xs mb-1">Mô tả tóm tắt câu chuyện</label>
            <textarea 
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2 text-green-400 font-semibold uppercase text-xs tracking-wider">
            <User className="w-4 h-4" /> Mô tả chi tiết các nhân vật
          </div>
      ...
      <div className="p-5 border-t border-gray-800 bg-[#060b3b]">
        <button
          onClick={onGenerate}
