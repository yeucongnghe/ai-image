        ...
        <div className="flex items-center gap-2">
          {isEditing ? (
            ...
            <>
              ...
              <button onClick={() => setIsEditing(true)} className="p-1.5 rounded-md hover:bg-gray-700 text-gray-400 transition-colors" title="Sửa lại cảnh">
                <Edit2 className="w-4 h-4" />
              </button>
              <button onClick={() => onDelete(scene.id)} className="p-1.5 rounded-md hover:bg-red-900/30 text-red-400 transition-colors" title="Xoá cảnh này">
      ...
      <div className="p-4 grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center mb-1">
            <span className="text-xs font-semibold text-gray-500 uppercase">Prompt tiếng Việt (Sẵn sàng để tạo Video)</span>
            {!isEditing && (
              <button 
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center mb-1">
            <span className="text-xs font-semibold text-gray-500 uppercase">Prompt tiếng Anh</span>
            {!isEditing && (
              <button 
