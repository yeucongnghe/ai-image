...
export const removeBackgroundAI = async (base64Image: string, settings: AppSettings): Promise<string> => {
  try {
    ...
    body: JSON.stringify({ 
      base64RefImage: base64Image, // Gửi ảnh
      settings: settings          // BẮT BUỘC phải gửi kèm settings ở đây
    }),
  });
